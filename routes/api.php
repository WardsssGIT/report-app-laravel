...
use App\Http\Controllers\Cdepartment;
...
//department
Route::post('/adddepartment',[Cdepartment::class,"addDepartment"]);//add department
Route::get('/indexdepartment',[Cdepartment::class,"showall"]);
});
